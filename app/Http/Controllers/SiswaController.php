...
{
    $siswa = Siswa::with(['perusahaan', 'kompetensi'])->latest()->get();
...
$siswa = Siswa::create([
    ...
    'tanggal_mulai_pkl' => $validated['tanggal_mulai'],
    'tanggal_selesai_pkl' => $validated['tanggal_selesai'],
]);
...
$siswa->kompetensi()->attach($validated['kompetensi']);
    ...
    {
        $siswa->load(['perusahaan', 'kompetensi']);
